    ...
    return (
        <div className="how-to-container">
            ...
            <div className="tutorial-box">
                ...
                <p className="how-to-text">   You start the game suffering from a constant nightmare. Click the game board to "flip" it over and view the details of the dream. After 2 minutes click to close and start the game by clicking on the top deck of cards</p>
            </div>
            <div className="tutorial-box">
