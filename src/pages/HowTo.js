    ...
    return (
        <div className="how-to-container">
            ...
            <div className="tutorial-box">
                ...
                <img className="how-to-pic" src="https://i.imgur.com/gWlexlN.png" alt="" />
            </div>
            <div className="tutorial-box">
                ...
                <img className="how-to-pic" src="https://i.imgur.com/9mH9UKX.png" alt="" />
            </div>
            <div className="tutorial-box">
                ...
                <img src="https://i.imgur.com/bvCluet.png" alt="" />
            </div>
            <div className="tutorial-box">
